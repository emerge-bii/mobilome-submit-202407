...
#################################
# run pydirseq for gene activity
################################
### see pydirseq detail description here: https://github.com/jiarong/pydirseq

Wkdir=~/mge/metat/nova-only.wkdir  # working directory
R1=nova-only/714E11014metaG_FD_JGI.1.fq.gz  #  RNAseq pair-end read1 file
